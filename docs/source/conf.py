...
# -*- coding: utf-8 -*-
#
# monomoy documentation build configuration file
#
...
_version_py = os.path.join(repo, "monomoy", "_version.py")
version_ns = {}
...
latex_documents = [
    (master_doc, "monomoy.tex", "monomoy Documentation", "me", "manual"),
]
...
man_pages = [(master_doc, "monomoy", "monomoy Documentation", [author], 1)]
